<?php if(!defined('BASEPATH')) { exit; } ?>﻿<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <link href="/Resource/Home/css/googleapicss.css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="/Resource/Home/css/style.css">
        <link rel="stylesheet" href="/Resource/Home/css/prettify.css">
    </head>
    ...
    <body>
        <div class="wrapper">
            <nav>
                <div class="pull-left">
                    <h1><a href="javascript:"><img src="/Resource/Home/img/icon.png" alt="Free Documentation Template Icon" /> <span>DocWeb</span></a></h1>
                </div>
                <div class="pull-right">
                    <a href="#/free-documentation-html-template-docweb" target="_blank" class="btn btn-download"><img src="/Resource/Home/img/download.png" width="25" alt="Download Free Documentation Template" /> Download Now</a>
                </div>
            </nav>
            <header>
                <div class="container">
            ...
            <section>
                <div class="container">
                    <ul class="docs-nav">
                        ...
                        <li>
                            <a href="#welcome" class="cc-active">欢迎</a>
                        </li>
                        <li>
                            <a href="#benefits" class="cc-active">创建应用</a>
                        </li>
                        <li>
                            <a href="#features" class="cc-active">加载页面</a>
                        </li>
                        <li>
                            <a href="#license" class="cc-active">缓存页面</a>
                        </li>
                        <li class="separator"></li>
                        <li><strong>核心</strong></li>
                        <li>
                            <a href="#view_type" class="cc-active">View Type</a>
                        </li>
                        <li>
                            <a href="#animation_style" class="cc-active">Animation Styles</a>
                        </li>
                        <li>
                            <a href="#bars_text" class="cc-active">Bars Text</a>
                        </li>
                        <li>
                            <a href="#vote_counter" class="cc-active">Vote Counter</a>
                        </li>
                        <li>
                            <a href="#rating_icons" class="cc-active">Rating Icons</a>
                        </li>
                        <li>
                            <a href="#rating_titles" class="cc-active">Rating Titles</a>
                        </li>
                        <li>
                            <a href="#bar_colors" class="cc-active">Bar Colors</a>
                        </li>
                    </ul>
                    <div class="docs-content">
                        ...
                        <ul>
                            ...
                            <li>Run crowd-sourced campaigns with Opineo to mature new ideas, website designs or logos
                            </li>
                        ...
                        <p> Before you make any cusomization or even start using Opineo create a 'div' element and assign it some id. Now add references to necessary Javascrip files e.g.</p>
                        <ul>
...
&lt;/script&gt;</pre>
        ...
        <script type="text/javascript" src="/Resource/Home/js/prettify/prettify.js"></script>
        <script src="/Resource/Home/js/layout.js"></script>
    </body>
